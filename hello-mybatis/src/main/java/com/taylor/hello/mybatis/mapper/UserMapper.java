package com.taylor.hello.mybatis.mapper;

import com.taylor.hello.mybatis.domain.User;
import com.taylor.hello.mybatis.mapper.utils.UserSqlProvider;
...
public interface UserMapper {
     ...
     * 方式1：使用注解编写SQL。
     */
    @Results(@Result(property = "mobileNum", column = "PHONE_NUM"))
